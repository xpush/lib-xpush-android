...
public class Manager extends Emitter {
    ...
    /*package*/ void close() {
        ...
        logger.info("111 close : " +  skipReconnect);
        this.backoff.reset();
        this.readyState = ReadyState.CLOSED;
        if (this.engine != null) {
            this.engine.close();
    ...
    private void onclose(String reason) {
        logger.info("222 close : " +  skipReconnect);
        this.cleanup();
        this.backoff.reset();
        this.readyState = ReadyState.CLOSED;
    ...
    private void reconnect() {
        ...
        logger.info( "this.backoff.getAttempts() :  " + this.skipReconnect  + ", " + this.backoff.getAttempts());
        logger.info( "_reconnectionAttempts " + this._reconnectionAttempts );
